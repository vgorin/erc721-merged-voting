// deploy: npx hardhat deploy --network goerli --tags TierDBv1
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	{
		// deploy if required
		await deployments.deploy("TierDBv1", {
		...
		const deployment = await deployments.get("TierDBv1");
...
module.exports.tags = ["TierDBv1", "deploy"];
