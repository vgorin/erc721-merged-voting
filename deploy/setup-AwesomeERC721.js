// run: npx hardhat deploy --network goerli --tags setup-AwesomeERC721
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// setup AwesomeERC721
	{
		...
		if(!features.eq(requested_features)) {
			...
			console.log("AwesomeERC721.updateFeatures(%o): %o", requested_features.toString(2), receipt.transactionHash);
		}
	}
};
...
module.exports.tags = ["setup-AwesomeERC721", "setup"];
module.exports.dependencies = ["AwesomeERC721"];
